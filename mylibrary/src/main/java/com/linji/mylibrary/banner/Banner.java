...
import com.linji.mylibrary.banner.listener.OnBannerListener;
import com.linji.mylibrary.banner.listener.OnBannerScrolledListener;
import com.linji.mylibrary.banner.listener.OnVideoStateListener;
import com.linji.mylibrary.banner.loader.ViewLoaderInterface;
import com.linji.mylibrary.banner.utils.FileTypeUtil;
import com.linji.mylibrary.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener, OnVideoStateListener {
    ...
    private OnBannerScrolledListener mOnBannerScrolledListener;
    ...
    private void setViewByLoader(Object url, boolean isVideo) {
        ...
        if (v == null) {
            v = isVideo ? new VideoView(context) : new LinearLayout(context);
        }
...
//            startAutoPlay();
        ...
        if (isScroll && count > 1) {
            ...
            JzvdStd view = (JzvdStd) imageViews.get(1);
            view.startVideo();
        }
    }
...
//        }
    ...
    public void onPageSelected(int position) {
        ...
        View view = imageViews.get(position);
        if (mOnBannerScrolledListener != null) {
            mOnBannerScrolledListener.onScrolled(view);
        }
    }
    ...
    public void setOnBannerScrolledListener(OnBannerScrolledListener mOnBannerScrolledListener) {
        this.mOnBannerScrolledListener = mOnBannerScrolledListener;
    }
}
